...
export const RESIZE_PRESETS: readonly ResizePreset[] = [
  ...
  { id: 'social_square', maxWidth: 1080, maxHeight: 1080, category: 'social', labelKey: 'settings.resizePresetSocialSquare' },
  ...
  { id: 'ecommerce_main', maxWidth: 800, maxHeight: 800, category: 'ecommerce', labelKey: 'settings.resizePresetEcommerceMain' },
  ...
  { id: 'avatar', maxWidth: 512, maxHeight: 512, category: 'thumb', labelKey: 'settings.resizePresetAvatar' },
